...
namespace ts {
    ...
    export function getOperatorPrecedence(nodeKind: SyntaxKind, operatorKind: SyntaxKind, hasArguments?: boolean): number {
        return RustyTypeScript.getOperatorPrecedence(nodeKind, operatorKind, hasArguments);
    }

    export function getBinaryOperatorPrecedence(kind: SyntaxKind): number {
        return RustyTypeScript.getBinaryOperatorPrecedence(kind);
    }
...
namespace ts {
    ...
    export function textSpanIntersection(span1: TextSpan, span2: TextSpan): TextSpan | undefined {
        return RustyTypeScript.textSpanIntersection(span1, span2);
    }
...
namespace ts {
    ...
    export function parsePseudoBigInt(stringValue: string): string {
        return RustyTypeScript.parsePseudoBigInt(stringValue);
    }

    export function pseudoBigIntToString(pseudoBigInt: PseudoBigInt): string {
        return RustyTypeScript.pseudoBigIntToString(pseudoBigInt);
    }
}
